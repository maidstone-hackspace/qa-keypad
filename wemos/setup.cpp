...
int config_access_point(const char *form_fields[], int number_of_fields) {
  ...
  server.serveStatic("/tachyon.css", SPIFFS, "/tachyon.css");
  server.serveStatic("/all.min.css", SPIFFS, "/all.min.css");
  server.serveStatic("/form.edn", SPIFFS, "/form.edn");
  server.serveStatic("/main.js", SPIFFS, "/main.js");
  server.serveStatic("/dev-main.js", SPIFFS, "/dev-main.js");
  server.serveStatic("/faavicon.ico", SPIFFS, "/favicon.ico");
